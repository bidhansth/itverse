<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="TeacherManagement.aspx.cs" Inherits="LMS.UserManagement.TeacherManagement.TeacherManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    <nav aria-label="breadcrumb" class="animate-fade-in">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><i class="fas fa-chalkboard-teacher me-1"></i>Teacher Management</li>
        </ol>
    </nav>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header animate-fade-in">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="page-subtitle">Manage and organize teacher records efficiently</p>
            </div>
            <div class="d-flex gap-2">
                <button type="button" class="btn-modern btn-outline-modern" onclick="refreshTeacherData()">
                    <i class="fas fa-sync-alt"></i>Refresh
                </button>
                <a href="AddTeacher.aspx" class="btn-modern btn-primary-modern">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card active animate-slide-up" style="animation-delay: 0.1s;">
                ...
                <div class="stats-number">
                    <asp:Label ID="lblActiveTeachers" runat="server" Text="0"></asp:Label>
                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card inactive animate-slide-up" style="animation-delay: 0.2s;">
                ...
                <div class="stats-number">
                    <asp:Label ID="lblInactiveTeachers" runat="server" Text="0"></asp:Label>
                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card new animate-slide-up" style="animation-delay: 0.3s;">
                ...
                <div class="stats-number">
                    <asp:Label ID="lblNewTeachers" runat="server" Text="0"></asp:Label>
                </div>
    ...
    <div class="table-container animate-fade-in">
        <div class="table-header">
            <h5><i class="fas fa-table me-2"></i>Teacher Directory</h5>
        ...
        <div class="table-wrapper">
            <!-- No Teachers Message -->
            <asp:Panel ID="pnlNoTeachers" runat="server" Visible="false">
                <div class="no-data-container">
                    <div class="no-data-icon">
                        <i class="fas fa-chalkboard-teacher"></i>
                    </div>
                    <h4 class="no-data-title">No Teachers Found</h4>
                    <p class="no-data-text">Start building your teaching team by adding your first teacher.</p>
                    <a href="AddTeacher.aspx" class="btn-modern btn-primary-modern">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Profile">
                        <ItemTemplate>
                            ...
                            %>' 
                            alt="Profile" class="teacher-avatar" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Teacher ID">
                        <ItemTemplate>
                            <div class="fw-semibold text-primary">TCH-<%# Eval("TeacherId").ToString().PadLeft(4, '0') %></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Teacher Information">
                        <ItemTemplate>
                            <div>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <div class="action-buttons">
                                <asp:LinkButton ID="btnViewTeacher" runat="server" 
                                    CommandName="ViewTeacher" 
                                ...
                                <a href='AddTeacher.aspx?id=<%# Eval("TeacherId") %>' 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="teacher-profile-header">
                        ...
                        <h3 id="modalTeacherName" class="profile-name"></h3>
                        <p id="modalTeacherId" class="profile-id"></p>
                        <div class="profile-status">
                            <span id="modalTeacherStatus" class="status-badge"></span>
                        </div>
                    </div>
                        ...
                        <div class="detail-section">
                            ...
                            <div class="detail-grid">
                                <div class="detail-item">
                                    ...
                                    <div id="modalQualification" class="detail-value">
                                        <i class="fas fa-certificate icon"></i><span></span>
                                    </div>
                                </div>
                                <div class="detail-item">
    ...
    <!-- Hidden field to store teacher data for modal -->
    <asp:HiddenField ID="hdnTeacherData" runat="server" />
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            setActiveMenuItem('TeacherManagement.aspx');
            ...
            // Initialize view teacher functionality
            initializeViewTeacher();
        });

        function initializeDataTable() {
            // Check if table exists and has rows
            const table = $('#<%= gvTeachers.ClientID %>');
            if (table.length === 0) {
            ...
            try {
                teachersTable = table.DataTable({
                    ...
                    "language": {
                        ...
                        "zeroRecords": "No teachers found matching your search criteria",
                        "emptyTable": "No teachers are currently registered in the system",
                        "paginate": {
                            "first": "First",
                            "last": "Last",
                            "next": "Next",
                    ...
                    "drawCallback": function(settings) {
                        ...
                        // Reinitialize view teacher functionality
                        initializeViewTeacher();
        ...
        function initializeFilters() {
            ...
            $('#genderFilter').on('change', function () {
                ...
                teachersTable.column(4).search(value).draw();
            });

            // Status filter
            $('#statusFilter').on('change', function () {
                const value = $(this).val();
                teachersTable.column(6).search(value).draw();
            });
        }
        ...
        function initializeViewTeacher() {
            // Handle view teacher button clicks
            $(document).off('click', '.btn-view').on('click', '.btn-view', function(e) {
                e.preventDefault();
                
                const row = $(this).closest('tr');
                const teacherData = extractTeacherDataFromRow(row);
                
                if (teacherData) {
                    populateTeacherModal(teacherData);
                    $('#teacherDetailsModal').modal('show');
                } else {
                    showErrorToast('Unable to load teacher details');
                }
            });
            ...
            $('#btnEditFromModal').off('click').on('click', function() {
                ...
                if (teacherId) {
                    window.location.href = `AddTeacher.aspx?id=${teacherId}`;
                }
            });
        }

        function extractTeacherDataFromRow(row) {
            try {
                ...
                // Get teacher ID from the formatted text (remove TCH- prefix and leading zeros)
                const teacherIdText = cells.eq(1).find('.fw-semibold').text().trim();
                const teacherId = teacherIdText.replace('TCH-', '').replace(/^0+/, '') || '0';
                ...
                // Get qualification
                const qualification = cells.eq(5).find('.fw-medium').text().trim();
                ...
                return {
                    ...
                    formattedId: teacherIdText
                };
            } catch (error) {
                console.error('Error extracting teacher data:', error);
                return null;
            }
        }
        ...
        function populateTeacherModal(data) {
            try {
                ...
                $('#modalTeacherName').text(data.fullName);
                $('#modalTeacherId').text(data.formattedId);
                
                // Status badge
                const statusBadge = $('#modalTeacherStatus');
                ...
                // Professional Information
                $('#modalQualification span').text(data.qualification || 'Not provided');
                ...
                // Set teacher ID for edit button
                $('#btnEditFromModal').data('teacher-id', data.teacherId);
                ...
                showErrorToast('Error displaying teacher details');
            }
        }
        ...
        function confirmStatusToggle(element) {
            ...
            const teacherName = row.find('td:eq(2) .fw-semibold').text().trim();
            const isActive = $(element).find('i').hasClass('fa-eye-slash');
            const action = isActive ? 'deactivate' : 'activate';
            const title = isActive ? 'Deactivate Teacher?' : 'Activate Teacher?';
            const text = `Are you sure you want to ${action} ${teacherName}?`;
        ...
        $(window).resize(function () {
            if (teachersTable) {
                teachersTable.responsive.recalc();
            }
        });
    </script>
</asp:Content>
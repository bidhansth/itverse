<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="LMS.UserManagement.TeacherManagement.AddTeacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    <nav aria-label="breadcrumb" class="animate-fade-in">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href='<%= ResolveUrl("~/UserManagement/TeacherManagement/TeacherManagement.aspx") %>'><i class="fas fa-chalkboard-teacher me-1"></i>Teacher Management</a></li>
            <li class="breadcrumb-item active"><i class="fas fa-user-plus me-1"></i>Add Teacher</li>
        </ol>
    </nav>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 runat="server" id="lblPageTitle" class="page-title mb-2">
                    <i runat="server" id="iconTitle" class="fas fa-chalkboard-teacher me-3"></i>
                    <asp:Literal ID="litPageTitle" runat="server" Text="Add New Teacher"></asp:Literal>
                </h1>

                <p runat="server" id="lblPageSubtitle" class="page-subtitle mb-0">
                    Register a new teacher to the learning management system
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="form-section">
                ...
                <div class="profile-upload-container">
                    <div class="profile-preview" id="profilePreview">
                        <i class="fas fa-chalkboard-teacher profile-placeholder" id="profilePlaceholder"></i>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvAddress" runat="server" 
                        ...
                        CssClass="validation-message"
                        Display="Dynamic">
                        <i class="fas fa-exclamation-circle"></i> Address is required
                    </asp:RequiredFieldValidator>
                </div>

                <div class="form-group">
                    <label class="form-label">
                        <i class="fas fa-graduation-cap"></i>Qualification<span class="required">*</span>
                    </label>
                    <asp:TextBox ID="txtQualification" runat="server" 
                        CssClass="form-control" 
                        placeholder="Enter educational qualification and experience"
                        TextMode="MultiLine"
                        Rows="3"
                        MaxLength="500" />
                    <asp:RequiredFieldValidator ID="rfvQualification" runat="server" 
                        ...
                        CssClass="validation-message"
                        Display="Dynamic">
                        <i class="fas fa-exclamation-circle"></i> Qualification is required
                    </asp:RequiredFieldValidator>
                </div>
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            const qualification = document.getElementById('<%= txtQualification.ClientID %>').value;
            if (qualification && qualification.trim().length < 10) {
                errorMessage += '• Qualification must be at least 10 characters long\n';
                isValid = false;
            }
        ...
        function showSuccessMessage(message) {
            ...
            Swal.fire({
                ...
                window.location.href = 'TeacherManagement.aspx';
            });
        }

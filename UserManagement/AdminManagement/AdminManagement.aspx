<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AdminManagement.aspx.cs" Inherits="LMS.UserManagement.AdminManagement.AdminManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <style>
        ...
        * {
        ...
        .stats-card.super .stats-number { color: #7c3aed; }
        .stats-card.super .stats-icon { color: #7c3aed; opacity: 0.2; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    <nav aria-label="breadcrumb" class="animate-fade-in">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><i class="fas fa-user-shield me-1"></i>Admin Management</li>
        </ol>
    </nav>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header animate-fade-in">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn-modern btn-outline-modern" onclick="refreshAdminData()">
                    <i class="fas fa-sync-alt"></i>Refresh
                </button>
                <a href="AddAdmin.aspx" class="btn-modern btn-primary-modern">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card active animate-slide-up" style="animation-delay: 0.1s;">
                ...
                <div class="stats-number">
                    <asp:Label ID="lblActiveAdmins" runat="server" Text="0"></asp:Label>
                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card inactive animate-slide-up" style="animation-delay: 0.2s;">
                ...
                <div class="stats-number">
                    <asp:Label ID="lblInactiveAdmins" runat="server" Text="0"></asp:Label>
                </div>
                <div class="stats-label">Inactive Admins</div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card super animate-slide-up" style="animation-delay: 0.3s;">
                <i class="fas fa-crown stats-icon"></i>
                <div class="stats-number">
                    <asp:Label ID="lblSuperAdmins" runat="server" Text="0"></asp:Label>
                </div>
    ...
    <div class="table-container animate-fade-in">
        <div class="table-header">
            <h5><i class="fas fa-table me-2"></i>Administrator Directory</h5>
        ...
        <div class="table-wrapper">
            ...
            <asp:Panel ID="pnlNoAdmins" runat="server" Visible="false">
                <div class="no-data-container">
                    ...
                    <h4 class="no-data-title">No Administrators Found</h4>
                    <p class="no-data-text">Start building your admin team by adding your first administrator.</p>
                    <a href="AddAdmin.aspx" class="btn-modern btn-primary-modern">
            ...
            <asp:GridView ID="gvAdmins" runat="server" 
                ...
                <Columns>
                        ...
                        <ItemTemplate>
                            ...
                            src='<%# 
                                ...
                                : "https://ui-avatars.com/api/?name=" + 
                                  ...
                                  "&background=dc2626&color=ffffff&size=40"
                            %>' 
                    ...
                    <asp:TemplateField HeaderText="Admin ID">
                        <ItemTemplate>
                            <div class="fw-semibold text-primary">ADM-<%# Eval("AdminId").ToString().PadLeft(4, '0') %></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="Administrator Information">
                        <ItemTemplate>
                            <div>
                    ...
                    <asp:TemplateField HeaderText="Type">
                        <ItemTemplate>
                            <span class='status-badge <%# Convert.ToBoolean(Eval("IsSuper")) ? "status-super" : "status-regular" %>'>
                                <i class='fas <%# Convert.ToBoolean(Eval("IsSuper")) ? "fa-crown" : "fa-user-cog" %> me-1'></i>
                                <%# Convert.ToBoolean(Eval("IsSuper")) ? "Super Admin" : "Regular Admin" %>
                            </span>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <div class="action-buttons">
                                <asp:LinkButton ID="btnViewAdmin" runat="server" 
                                    CommandName="ViewAdmin" 
                                ...
                                <a href='AddAdmin.aspx?id=<%# Eval("AdminId") %>' 
    ...
    <!-- Admin Details Modal -->
    <div class="modal fade" id="adminDetails" tabindex="-1" aria-labelledby="adminDetailsModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="admin-profile-header">
                        ...
                        <h3 id="modalAdminName" class="profile-name"></h3>
                        <p id="modalAdminId" class="profile-id"></p>
                        <div class="profile-status">
                            <span id="modalAdminStatus" class="status-badge"></span>
                            <span id="modalAdminType" class="status-badge ms-2"></span>
                        </div>
                    </div>
                    ...
                    <div class="admin-details">
                        ...
                        <div class="detail-section">
                            ...
                            <div class="detail-grid">
                                ...
                                <div class="detail-item">
                                    <div class="detail-label">Administrator Type</div>
                                    <div id="modalAdminTypeDetail" class="detail-value"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detail-section">
                            ...
                            <div class="detail-grid">
                                ...
                                <div class="detail-item">
                                    <div class="detail-label">Permission Level</div>
                                    <div id="modalPermissionLevel" class="detail-value"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Hidden field to store admin data for modal -->
    <asp:HiddenField ID="hdnAdminData" runat="server" />
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            setActiveMenuItem('AdminManagement.aspx');
            ...
            // Initialize view admin functionality
            initializeViewAdmin();
        });

        function initializeDataTable() {
            // Check if table exists and has rows
            const table = $('#<%= gvAdmins.ClientID %>');
            if (table.length === 0) {
            ...
            try {
                adminsTable = table.DataTable({
                    ...
                    "language": {
                        ...
                        "infoEmpty": "No administrators found",
                        "infoFiltered": "(filtered from _MAX_ total administrators)",
                        "zeroRecords": "No administrators found matching your search criteria",
                        "emptyTable": "No administrators are currently registered in the system",
                        "paginate": {
                            "first": "First",
                            "last": "Last",
                            "next": "Next",
                    ...
                    "drawCallback": function(settings) {
                        ...
                        // Reinitialize view admin functionality
                        initializeViewAdmin();
        ...
        function initializeFilters() {
            ...
            $('#genderFilter').on('change', function () {
                ...
                adminsTable.column(4).search(value).draw();
            });

            // Status filter
            $('#statusFilter').on('change', function () {
                const value = $(this).val();
                adminsTable.column(6).search(value).draw();
            });

            // Type filter
            $('#typeFilter').on('change', function () {
                const value = $(this).val();
                adminsTable.column(5).search(value).draw();
            });
        }
        ...
        function initializeViewAdmin() {
            // Handle view admin button clicks
            $(document).off('click', '.btn-view').on('click', '.btn-view', function(e) {
                e.preventDefault();
                
                const row = $(this).closest('tr');
                const adminData = extractAdminDataFromRow(row);
                
                if (adminData) {
                    populateAdminModal(adminData);
                    $('#adminDetailsModal').modal('show');
                } else {
                    showErrorToast('Unable to load admin details');
                }
            });
            ...
            $('#btnEditFromModal').off('click').on('click', function() {
                ...
                if (adminId) {
                    window.location.href = `AddAdmin.aspx?id=${adminId}`;
                }
            });
        }

        function extractAdminDataFromRow(row) {
            try {
                ...
                // Get admin ID from the formatted text (remove ADM- prefix and leading zeros)
                const adminIdText = cells.eq(1).find('.fw-semibold').text().trim();
                const adminId = adminIdText.replace('ADM-', '').replace(/^0+/, '') || '0';
                ...
                // Get admin type
                const typeElement = cells.eq(5).find('.status-badge');
                const isSuper = typeElement.hasClass('status-super');
                const adminType = isSuper ? 'Super Admin' : 'Regular Admin';
                
                // Get status
                const statusElement = cells.eq(6).find('.status-badge');
                const isActive = statusElement.hasClass('status-active');
                const status = isActive ? 'Active' : 'Inactive';
                
                // Get joined date
                const joinedDateElement = cells.eq(7).find('.fw-medium');
                const joinedTimeElement = cells.eq(7).find('.text-muted');
        ...
        function populateAdminModal(data) {
            try {
                ...
                $('#modalAdminName').text(data.fullName);
                $('#modalAdminId').text(data.formattedId);
                
                // Status badges
                const statusBadge = $('#modalAdminStatus');
                ...
                const typeBadge = $('#modalAdminType');
                typeBadge.removeClass('status-super status-regular');
                typeBadge.addClass(data.isSuper ? 'status-super' : 'status-regular');
                typeBadge.html(`<i class="fas ${data.isSuper ? 'fa-crown' : 'fa-user-cog'} me-1"></i>${data.adminType}`);
                ...
                $('#modalAdminTypeDetail').html(`<span class="status-badge ${data.isSuper ? 'status-super' : 'status-regular'}">${data.adminType}</span>`);
                
                // Contact Information
                $('#modalEmail span').text(data.email || 'Not provided');
                $('#modalPhone span').text(data.contactNumber || 'Not provided');
                $('#modalAddress span').text('Not provided'); // This would need to be added to your data extraction
                ...
                $('#modalPermissionLevel').html(`<span class="status-badge ${data.isSuper ? 'status-super' : 'status-regular'}">${data.adminType}</span>`);
                
                // Set admin ID for edit button
                $('#btnEditFromModal').data('admin-id', data.adminId);
                ...
                $('.detail-value').each(function() {
                    ...
                    if (!text || text.trim() === 'Not provided' || text.trim() === 'Not available') {
                        ...
                        } else if (!$this.hasClass('status-badge') && !$this.find('.status-badge').length) {
                ...
                showErrorToast('Error displaying admin details');
            }
        }
        ...
        function refreshAdminData() {
            showInfoToast('Refreshing admin data...');
            setTimeout(function() {
        ...
        function confirmStatusToggle(element) {
            ...
            const adminName = row.find('td:eq(2) .fw-semibold').text().trim();
            const isActive = $(element).find('i').hasClass('fa-eye-slash');
            const action = isActive ? 'deactivate' : 'activate';
            const title = isActive ? 'Deactivate Administrator?' : 'Activate Administrator?';
            const text = `Are you sure you want to ${action} ${adminName}?`;
                ...
                html: `
                    <div class="text-start">
                        <p class="text-danger mt-3">
                            ...
                            This action cannot be undone. The administrator record will be permanently removed.
                        </p>
                    </div>
                `,
                icon: 'warning',

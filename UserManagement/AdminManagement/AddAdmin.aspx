<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AddAdmin.aspx.cs" Inherits="LMS.UserManagement.AdminManagement.AddAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    <nav aria-label="breadcrumb" class="animate-fade-in">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href='<%= ResolveUrl("~/UserManagement/AdminManagement/AdminManagement.aspx") %>'><i class="fas fa-user-shield me-1"></i>Admin Management</a></li>
            <li class="breadcrumb-item active"><i class="fas fa-user-plus me-1"></i>Add Admin</li>
        </ol>
    </nav>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 runat="server" id="lblPageTitle" class="page-title mb-2">
                    <i runat="server" id="iconTitle" class="fas fa-user-shield me-3"></i>
                    <asp:Literal ID="litPageTitle" runat="server" Text="Add New Admin"></asp:Literal>
                </h1>

                <p runat="server" id="lblPageSubtitle" class="page-subtitle mb-0">
                    Register a new administrator to the learning management system
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="form-content">
            ...
            <div class="form-section">
                ...
                <div class="profile-upload-container">
                    <div class="profile-preview" id="profilePreview">
                        <i class="fas fa-user-shield profile-placeholder" id="profilePlaceholder"></i>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <h3 class="section-title">Administrative Settings</h3>
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox-container">
                        ...
                        <small class="text-muted d-block mt-2">
                            Super administrators have full system access and can manage other administrators
                        </small>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            // Validate age (admin should be 18+)
            const age = parseInt(document.getElementById('<%= txtAge.ClientID %>').value);
            if (age && (age < 18 || age > 100)) {
                errorMessage += '• Age must be between 18 and 100 years for administrator\n';
                isValid = false;
            }
            ...
            // Validate password strength (admin requires stronger password)
            if (password && password.length < 8) {
                errorMessage += '• Password must be at least 8 characters long for administrator\n';
                isValid = false;
            }
